...
protected:
	...
	typedef typename std::unordered_map<std::string,
										std::shared_ptr<mesh>>::iterator
		mesh_list_iterator;
	typedef typename std::unordered_map<std::string,
										std::shared_ptr<mesh>>::const_iterator
		const_mesh_list_iterator;
	typedef typename std::unordered_map<std::string,
										std::shared_ptr<material>>::iterator
		material_list_iterator;
	typedef
		typename std::unordered_map<std::string,
									std::shared_ptr<material>>::const_iterator
			const_material_list_iterator;
};
} // namespace glapp
